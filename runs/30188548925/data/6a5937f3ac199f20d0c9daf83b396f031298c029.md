    ...
    - complementary [ref=f1e3]:
      - generic [ref=f1e4]:
        ...
        - generic [ref=f1e20]:
          ...
          - link "Share as a public link →" [ref=f1e22] [cursor=pointer]:
            - /url: index.html#share
          - button "Copy markdown" [active] [ref=f1e23] [cursor=pointer]
          - button "← Editor" [ref=f1e24] [cursor=pointer]
          - link "← Home" [ref=f1e25] [cursor=pointer]:
            - /url: index.html
    - main [ref=f1e26]:
      - generic [ref=f1e28]:
        - generic [ref=f1e29]:
          - generic [ref=f1e30]: Cognitiva. · Guía de Docker
          - heading "Instalación" [level=1] [ref=f1e31]
        - paragraph [ref=f1e34]: Instrucciones de instalación.
        - button "Next → Conceptos Básicos" [ref=f1e37] [cursor=pointer]:
          - generic [ref=f1e38]: Next →
          - generic [ref=f1e39]: Conceptos Básicos
    - complementary [ref=f1e41]:
      - generic [ref=f1e42]: On this page
      - navigation
```
